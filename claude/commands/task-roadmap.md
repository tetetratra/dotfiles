...
後段のフェーズで解決できず、今最初に解決しなければならない不明点がある場合は、その不明点をユーザーに質問してください。
...
```
## フェーズの提案
1. {フェーズ名} ({推奨するコマンド}): {そのフェーズで行うこと}
2. {フェーズ名} ({推奨するコマンド}): {そのフェーズで行うこと}
...
...
- 対応方針に従って、フェーズの例から適切なフェーズを選び、フェーズを完成させてください
