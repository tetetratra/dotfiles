...
- タスクの要件はすでに定義されている、もしくは自明(= タスクの目的そのまま)ですか？
  - yes: 次へ
  - no: 「要件定義」を追加し、次へ
...
```
## 作業ステップの提案
1. {ステップ名} ({推奨するカスタムコマンド}): {そのステップで行うこと}
2. {ステップ名} ({推奨するカスタムコマンド}): {そのステップで行うこと}
...
