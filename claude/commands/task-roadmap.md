...
以下のStepに従ってください。
Step 2 にてユーザーに確認・質問を行うフェーズを設けています。
Step 2 の段階で一旦質問のレスポンスを返し、ユーザーからの回答を得てから Step 3 以降に進んでください。
...
分析にあたって情報が不足している場合は改めて調査を行い、それでも判断材料が無い場合、以下の方針で対応してください。

- 確度を高く仮の答えを出せる場合、その仮の答えを採用する
- 本当にわからない場合、Step 2 の質問フェーズの際にまとめて質問する
...
- **確認A**: タスクに関連する既存システムや機能について、理解しているか？
  - タスクに関連する既存システムや機能を提示し、ユーザーがそれを理解しているかを質問してください
...
- **確認B**: タスクに必要な新しい技術・概念について、理解しているか？
  - タスクに関連する技術・概念を提示し、ユーザーがそれを理解しているかを質問してください
  - 理解していない場合、Step 4にて「(それらの)新しい技術・概念を(ユーザーが)理解する」という作業ステップを追加してください
  - 今このロードマップを引いている作業中に調査・説明する必要はありません

- **確認C**: タスク完了後、結果を正式に報告・ドキュメント化する必要があるか？また必要な場合、どのような形式で報告するか？
...
- **既存システムの調査**: 今回のタスクに関連するシステムの仕組みについて調査をし、**あなた(AI)が理解を深める**
- **関連技術の理解**: 今回のタスクに関連する技術や概念について調査をし、**あなた(AI)が理解を深める**
- **既存システムの理解**: 今回のタスクに関連するシステムの仕組みについて、**ユーザーの理解を深めさせる**
- **関連技術の理解**: 今回のタスクに関連する技術や概念について、**ユーザーの理解を深めさせる**
